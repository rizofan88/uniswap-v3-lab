...
import { ADDRESSES, getLocalSignerByAddress, getLocalWalletByAddress } from "../ethereum";
import { FeeAmount } from "@uniswap/v3-sdk";
import { getERC20, approveToken, resolveToken } from "../tokens";
...
export async function swapInputSingle(
    ...
    amountOutMin = "0",
    port = "8545",
    swapRouterDeployed = "" //0xB5a80385dC0bE701CA9960F639295B0430199446
    ...
    try {
        ...
        for(const log of receipt.logs) {
            ...
            if (log.address === tokens.out.address) {
                ...
                const parsed = await getERC20(tokens.out.address, signer).interface.parseLog(log);
...
/* (async () => {
   await swapInputSingle(
    ADDRESSES.MAINNET.WETH,
    ADDRESSES.MAINNET.DAI,
    "0xe0E3Fa968E5888Ce9458878C392fE1711c8FF54d",
    "0.01",
    "0",
    "8545"
   );
